...
function btnEncriptar() {
  ...
  //devolvemos el placeholder al campo entrada
    document.getElementById("texto-a-encriptar").placeholder =
    "Aquí escribe tu texto a encriptar. Las mayúsculas se convertirán a minúsculas.                                       Para reiniciar el encriptador puedes presionar culaquier botón dos veces.";
}
